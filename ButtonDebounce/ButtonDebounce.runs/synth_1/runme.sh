...
HD_PWD='E:/Verilog Practice/Project_4/ButtonDebounce/ButtonDebounce.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ButtonDebounce.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ButtonDebounce.tcl
