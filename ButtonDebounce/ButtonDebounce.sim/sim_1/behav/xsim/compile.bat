...
REM
REM Generated by Vivado on Thu Jul 31 19:40:17 -0400 2025
...
echo "xvlog --incr --relax -prj ButtonDebounce_TB_vlog.prj"
call xvlog  --incr --relax -prj ButtonDebounce_TB_vlog.prj -log xvlog.log
